...
class SemesterResultCard extends StatelessWidget {
  ...
  List<Widget> _buildSubjectGrades() {
    ...
    if (semester == 4) {
      // For S4, use the predefined order
      ...
      // For other semesters, sort alphabetically
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: (isBacklog ? Colors.red : _getGradeColor(value)).withOpacity(0.3),
                      blurRadius: 4,
  ...
  String _formatSubjectCode(String code, int semester) {
    if (semester == 4) {
      // S4 Subjects with proper formatting
